...
<div  id="cn-cmap"  data-id="<?php echo $entry->getID(); ?>"  class="cn-template cn-cmap ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom" id="cn-list-body" role="tabpanel" aria-expanded="false" aria-hidden="true" style="display:none;">
            ...
            <div id="entry-id-<?php echo $entry->getRuid(); ?>" class="cn-entry" rel="<?php echo $entry->getRuid(); ?>">
				...
				<?php
					...
					if(strpos($block,"cn-image-none")===false){	
						echo '<div class="cn-right displayImg" style="float:right">'.$block.'</div>';
						$hasImg = true;
					}
				?>
