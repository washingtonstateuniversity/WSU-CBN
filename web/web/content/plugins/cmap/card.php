...
<div class="accordion"> 
<h3 tabindex="0" class="ui-accordion-header ui-helper-reset ui-state-default ui-accordion-icons ui-accordion-header-active ui-state-active ui-corner-top" id="ui-accordion-1-header-0" role="tab" aria-selected="true" aria-controls="ui-accordion-1-panel-0"><span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-s"></span><a style="" hidefocus="true" href="#"><em class="right"><?php 
if ( $atts['show_addresses'] ) $entry->getAddressBlock( array( 'format' => '%city%, %state%' , 'type' => $atts['address_types'] ) );

?></em><strong>&nbsp;&nbsp;<?php $entry->getNameBlock( array( 'format' => '%first%', 'link' => $atts['link'] ) ); ?></strong></a></h3>
