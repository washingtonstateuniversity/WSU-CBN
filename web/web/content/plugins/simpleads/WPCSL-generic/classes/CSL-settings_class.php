...
class wpCSL_settings__simpleads {
    ...
    function add_section($params) {
        if (!isset($this->sections[$params['name']])) {
            $this->sections[$params['name']] = new wpCSL_settings_section__simpleads(
                array_merge(
                    $params,
...
/****************************************************************************
 **
 ** class: wpCSL_settings_section__simpleads
 **
 **/
class wpCSL_settings_section__simpleads {
    ...
    function add_item($params) {
        $this->items[] = new wpCSL_settings_item__simpleads(
            array_merge(
                $params,
                array('plugin_url' => $this->plugin_url,
                      'css_prefix' => $this->css_prefix,
...
/****************************************************************************
 **
 ** class: wpCSL_settings_item__simpleads
 **
