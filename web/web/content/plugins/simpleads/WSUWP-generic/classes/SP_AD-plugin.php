...
require_once('SP_AD-cache_class.php');
require_once('SP_AD-helper_class.php');
require_once('SP_AD-license_class.php');
require_once('SP_AD-notifications_class.php');
require_once('SP_AD-products_class.php');
require_once('SP_AD-settings_class.php');
require_once('SP_AD-themes_class.php');


class wsuwp_plugin__simpleads {
    ...
    function create_helper($class = 'none') {
        switch ($class) {
            ...
            case 'wsuwp_helper__simpleads':
            case 'default':
            default:
                $this->helper = new wsuwp_helper__simpleads($this->helper_config);
    ...
    function create_notifications($class = 'none') {
        switch ($class) {
            ...
            case 'wsuwp_notifications__simpleads':
            case 'default':
            default:
                $this->notifications = 
                    new wsuwp_notifications__simpleads($this->notifications_config);
        }
    }
    ...
    function create_products($class = 'none') {
        switch ($class) {
            ...
            case 'wsuwp_products__simpleads':
            case 'default':
            default:
                $this->products = new wsuwp_products__simpleads($this->products_config);
    ...
    function create_settings($class = 'none') {
        switch ($class) {
            ...
            case 'wsuwp_settings__simpleads':
            case 'default':
            default:
                $this->settings = new wsuwp_settings__simpleads($this->settings_config);
    ...
    function create_themes($class = 'none') {
        switch ($class) {
            ...
            case 'default':
            default:
                $this->themes = new wsuwp_themes__simpleads($this->themes_config);
    ...
    function create_license($class = 'none') {
        switch ($class) {
            ...
            case 'wsuwp_license__simpleads':
            case 'default':
            default:
                if ($this->has_packages || !$this->no_license) {
                    $this->license = new wsuwp_license__simpleads($this->license_config);
                }
    ...
    function create_cache($class = 'none') {
        switch ($class) {
            ...
            case 'wsuwp_cache__simpleads':
            case 'default':
            default:
                $this->cache = new wsuwp_cache__simpleads($this->cache_config);
     ...
     ** properties of the main SP_AD-plugin class to each other.  For example
     ...
     ** It was separated to continue the generalization of wsuwp.
     **
