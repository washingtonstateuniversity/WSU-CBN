...
}else{l.data("toggled",true);l.text(k);g("#"+m).slideDown();}return false;});var b=g("#cn-gmap-single").length?g("#cn-gmap-single"):false;if(b!=false){var f=0;
var a=0;var d=b.attr("data-gmap-id");var c=g("#map-"+d).attr("data-address");var h=g("#map-"+d).attr("data-maptype");var e=parseInt(g("#map-"+d).attr("data-zoom"));
